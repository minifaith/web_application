...
<div class="container">
    <form method="POST" action="${contextPath}/login" class="form-signin" accept-charset="UTF-8">
        ...
        <div class="form-group">
            ...
            <br>
            <h4 class="text-center refer"><a href="${contextPath}/registration.jsp">Создать аккаунт</a></h4>
        </div>
    </form>

    <form method="GET" action="${contextPath}/index.jsp" class="form-signin">
        <div class="form-group">
            <button class="btn btn-lg btn-primary btn-block" type="submit">Войти как гость</button>
        </div>
    </form>
</div>
</body>
